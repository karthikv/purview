import { Fragment, Component, ComponentConstructor } from "../purview"
...
export namespace JSXInternal {
  export interface Element<T extends HTMLAttributes = HTMLAttributes> {
  ...
  export interface FragmentElement<
    P extends { children: any } = { children: any }
  > {
    nodeName: Fragment<P>
    attributes: {}
    children: Child | NestedArray<Child>
  ...
  export interface NormalElement extends Element {
    nodeName: string
  }
